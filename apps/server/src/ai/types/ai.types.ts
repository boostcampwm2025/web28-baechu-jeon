...
export interface Step2Result {
  responsibility_hypotheses: Step21Result['responsibility_hypotheses'];
  project_intent: Step22Result['project_intent'];
  user_stories: Step22Result['user_stories'];
}

export type Step22Input = { project: Project; analysisResult: AnalysisResult };

/** Step3 AI 응답: 프로젝트 의도 + 사용자 스토리(related_paths = 폴더·파일 경로) */
export interface Step22Result {
  project_intent: {
    overview: string;
    purpose: string;
